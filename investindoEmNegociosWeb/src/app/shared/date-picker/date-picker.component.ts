...
@Component({
  ...
  styles: [`
    ...
    .date-picker__input {
      width: 100%;
      min-height: var(--control-h, 52px);
      padding: 0 2.6rem 0 1rem;
      border: 1px solid var(--control-border, var(--border));
      border-radius: var(--radius-lg);
      background: var(--control-background, var(--surface));
      color: var(--text);
    ...
    .date-picker__input:focus {
      ...
      background: var(--control-background-focus, var(--surface));
      box-shadow: 0 0 0 4px var(--control-focus-ring, color-mix(in srgb, var(--primary) 20%, transparent));
    }
    ...
    .date-picker__toggle:hover { color: var(--text); background: var(--surface-2); }
    ...
    .date-popover__nav:hover { background: var(--surface-3, var(--surface-2)); }
    ...
    .date-popover__day:hover:not(:disabled) { background: var(--surface-2); }
    .date-popover__day--empty { cursor: default; }
    .date-popover__day--today { border-color: var(--border-strong, var(--border)); font-weight: var(--font-weight-semibold, 600); }
    ...
    .date-popover__day:disabled { color: var(--text-muted); opacity: 0.35; cursor: not-allowed; }
    ...
    .date-popover__today-btn:hover { background: var(--surface-2); }
